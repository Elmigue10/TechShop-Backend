package com.techshop.web.busines.security;

import com.techshop.web.busines.security.config.CustomJwtAuthenticationFilter;
import com.techshop.web.busines.security.config.CustomUserDetailsService;
import com.techshop.web.busines.security.config.JwtAuthenticationEntryPoint;
    ...
    public void configure(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .antMatchers("/techshop/web/v1/authenticate",
                        "/techshop/web/v1/register","/techshop/web/v1/user/save")
                .permitAll()
                .anyRequest()
                .authenticated().and()
